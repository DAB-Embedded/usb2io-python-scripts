...
#put data to buffer
rs485_data = bytearray(packet_len * packets_cnt)
...
if (put_buffer(ser, rs485_data) == 0):
	sys.exit(0)


print("RS485 Writing...")

# format: rs485 writebuffersync channel, packet_len, packet_cnt, trigger_timeout
if usb2io_sendcmd(ser, "rs485 writebuffersync 4," + str(packet_len) + ", " + str(packets_cnt) + ", " + str(trigger_timeout) + "\r\n") != "OK\r\n":
	print "failed."
	sys.exit(0)
