...
allow_ov9655_init_vga       = 0
allow_ov9655_init_vga_min   = 1
allow_ov9655_dump_regs      = 1
...
usb2io_command_timeout(ser, "camera stop\r\n", 1.2)
...
print ("Get OV9655 HWID")
ov9655_reg_read(ser, 0x1c)
ov9655_reg_read(ser, 0x1d)

#QVGA -> 800x248 ((320 + 80 = 400) x 2 = 800), DMA 0x18380
#VGA  -> 1600x500, DMA ?
...
if allow_ov9655_init_qvga :
    ...
    # camer start 
    # pclk_pol      : 1 - Rising, 0 - Falling
    # hsync_pol     : 1 - HSYNC polarity high, 0 - HSYNC polarity low
    # vsync_pol     : 1 - VSYNC polarity high, 0 - VSYNC polarity low
    # size          : of image in 4 bytes values (DWORDs) - WARNING: Very important to keep value correct
    # capture mode  : 0 - single snapshot, 1 - continious mode
    img_width       = 320
    img_heigh       = 240
    img_hsync_width = 80
    img_vsync_width = 8
    imgsize = ((img_width + img_hsync_width) * (img_heigh + img_vsync_width))
    usb2io_command(ser, "camera start 0x1,0x0,0x1," + hex(imgsize) + ",1\r\n")
...
if allow_ov9655_init_vga :
    ...
    img_hsync_width = 160
    img_vsync_width = 16
    imgsize = ((img_width + img_hsync_width) * (img_heigh + img_vsync_width))/2
    usb2io_command(ser, "camera start 0x1,0x0,0x1," + hex(imgsize) + ",1\r\n")
